"""visa_group/settings/visa.py — visapvtltd.co.in"""
import os
from .base import *
...
# Production security — Nginx terminates SSL at proxy level
SECURE_PROXY_SSL_HEADER = ('HTTP_X_FORWARDED_PROTO', 'https')
SECURE_SSL_REDIRECT = False  # Nginx handles this, not Django
if not DEBUG:
